...
from instagrapicustom.exceptions import ClientError, ClientNotFoundError, MediaNotFound
from instagrapicustom.extractors import extract_comment
from instagrapicustom.types import Comment
